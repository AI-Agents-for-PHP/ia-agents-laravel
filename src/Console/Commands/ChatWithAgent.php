...
namespace CaiqueBispo\AiAgentsLaravel\Console\Commands;
...
class ChatWithAgent extends Command
{
    ...
    public function handle()
    {
        if (class_exists($this->argument('agent'))) {
            ...
            $agentClass = "\CaiqueBispo\AiAgentsLaravel\Agents\\" . $this->argument('agent');
        }
        $agent = new $agentClass(new \CaiqueBispo\AiAgentsLaravel\ChatModels\ChatGPT());
